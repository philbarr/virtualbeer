 ...
 * 
 * @author mzechner */
public class VuforiaAndroidApplication extends Activity implements Application {
	static {
		GdxNativesLoader.load();
	}

	protected VuforiaAndroidGraphics graphics;
	...
	public void initialize (ApplicationListener listener, AndroidApplicationConfiguration config) {
		graphics = new VuforiaAndroidGraphics(this, config, config.resolutionStrategy == null ? new FillResolutionStrategy()
	...
	public void exit () {
		handler.post(new Runnable() {
			@Override
			public void run () {
				VuforiaAndroidApplication.this.finish();
			}
		});
	}
